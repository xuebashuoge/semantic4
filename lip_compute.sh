...
python lip_compute.py --name_data mnist --model fcn --layers 4 --init_prior random --l_0 2 --channel_type bec --clamping --lip_name test-set

python lip_compute.py --name_data mnist --model fcn --layers 4 --init_prior random --l_0 2 --channel_type bec --no-clamping --lip_name test-set
