...
def loadbatches(train, test, loader_kargs, batch_size, lip_bs=100, prior=False, perc_train=1.0, perc_prior=0.2):
    ...
    if prior == False:
        ...
        # additional dataloader for the lipschitz constant estimation
        all_dataset = ConcatDataset([train, test])
